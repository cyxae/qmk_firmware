...
bool achordion_chord(uint16_t tap_hold_keycode,
  ...
  switch (tap_hold_keycode) {
    // Allow all Ctrl+<letter> as a same-hand chord on the left.
    case CKC_D:
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAV] = LAYOUT_split_3x5_3(
    KC_WBAK,    ALT_TAB,    KC_F8,      KC_WFWD,    ALT_F4,           KC_TRNS,    KC_HOME,    KC_PGDN,    KC_PGUP,    KC_END,
    KC_ESC,     KC_ENT,     KC_TAB,     S(KC_TAB),  KC_DEL,           C(KC_BSPC), KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,
  ...
  [_NUM] = LAYOUT_split_3x5_3(
    KC_KP_DOT,  KC_7,       KC_8,       KC_9,       KC_TRNS,          KC_TRNS,    KC_F7,      KC_F8,      KC_F9,      KC_F12,
    KC_0,       KC_4,       KC_5,       KC_6,       KC_SPC,           KC_TRNS,    KC_F4,      KC_F5,      KC_F6,      KC_F11,
    KC_NUM,     KC_1,       KC_2,       KC_3,       KC_BSPC,          KC_TRNS,    KC_F1,      KC_F2,      KC_F3,      KC_F10,
